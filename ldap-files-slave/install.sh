...
ldapadd -x -D cn=Manager,dc=nsm,dc=in -w "master@@321" -f global.ldif

# Adding NSM attributes

ldapadd -Y EXTERNAL -H ldapi:/// -f nsmattribute.ldif

authconfig --enableldap --enableldapauth --ldapserver=10.0.10.7 --ldapbasedn="dc=nsm,dc=in" --enablemkhomedir --update
